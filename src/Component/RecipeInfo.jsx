...
//       ingredient => checkedIngredients.includes(ingredient.id)
//     );
//     localStorage.setItem('selectedIngredients', JSON.stringify(selectedIngredients));
//     addToIngredient(selectedIngredients);
//   };
  
//   const handleSaveCheckedIngredients = () => {
...
//                                     checkedIngredients.filter(id => id !== ingredient.id)
//                                   );
//                                 }
//                               }}
//                             />
...
//                       <button className="btn btn-primary" onClick={handleAddToIngredients}>
...
//                 <button className="btn btn-primary" onClick={handleSaveCheckedIngredients}>
//                   Guardar ingredientes seleccionados
//                 </button>
//                </div>
//              </div>
