...
import IngredientForm from "../src/Component/IngredientForm.jsx"; // importa el componente a probar
...
describe("IngredientForm", () => {
  ...
  test('should render recipe image', () => {
    ...
    expect(imageElement).toHaveStyle("background-image: url(https://example.com/ingredient.jpg)");
  });
});
